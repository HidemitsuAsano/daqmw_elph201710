...
static const char* drs4qdc2reader_spec[] =
  {
    "implementation_id", "Drs4QdcReader2",
    "type_name",         "Drs4QdcReader2",
    "description",       "Drs4QdcReader2 component",
    "version",           "1.0",
...
//______________________________________________________________________________
Drs4QdcReader2::Drs4QdcReader2(RTC::Manager* manager)
  : DAQMW::DaqComponentBase(manager),
    m_OutPort("out3", m_out_data),
    m_sock(nullptr),
    m_data(),
    m_header(), 
    m_recv_byte_size(0),
    ...
    m_cmd_close_gate()
{
  ...
  // Set OutPort buffers
  registerOutPort("out3", m_OutPort);

  init_command_port();
  init_state_table();
  set_comp_name("Drs4QdcReader2");
}

//______________________________________________________________________________
Drs4QdcReader2::~Drs4QdcReader2()
{
  delete m_sock;
  m_sock = nullptr;
}
...
//______________________________________________________________________________
RTC::ReturnCode_t Drs4QdcReader2::onInitialize()
{
  if (m_debug) {
    std::cerr << "Drs4QdcReader2::onInitialize()" << std::endl;
  }
...
//______________________________________________________________________________
RTC::ReturnCode_t Drs4QdcReader2::onExecute(RTC::UniqueId ec_id)
{
  daq_do();
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_dummy()
{
  return 0;
}

//______________________________________________________________________________
int Drs4QdcReader2::daq_configure()
{
  std::cerr << "*** Drs4QdcReader2::configure" << std::endl;
  ...
  m_sock->setOptRecvTimeOut(10.0); // 10 seconds
  std::cout << "************************" << std::endl;
...
//______________________________________________________________________________
int Drs4QdcReader2::parse_params(::NVList* list)
{
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_unconfigure()
{
  std::cerr << "*** Drs4QdcReader2::unconfigure" << std::endl;
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_start()
{
  m_out_status = BUF_SUCCESS;
  
  std::cerr << "*** Drs4QdcReader2::start" << std::endl;
  /*
  try {
    // create socket and connect to frontend
    m_sock = new DAQMW::Sock;
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_stop()
{
  std::cerr << "*** Drs4QdcReader2::stop" << std::endl;
  changeDaqMode(false);
  resetFIFO();
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_pause()
{
  std::cerr << "*** Drs4QdcReader2::pause" << std::endl;

  return 0;
}

//______________________________________________________________________________
int Drs4QdcReader2::daq_resume()
{
  std::cerr << "*** Drs4QdcReader2::resume" << std::endl;

  return 0;
}

//______________________________________________________________________________
int Drs4QdcReader2::read_adc()
{
...
//______________________________________________________________________________
int Drs4QdcReader2::set_data(unsigned int data_byte_size)
{
...
//______________________________________________________________________________
int Drs4QdcReader2::write_OutPort()
{
...
//______________________________________________________________________________
int Drs4QdcReader2::daq_run()
{
  if (m_debug) {
    std::cerr << "*** Drs4QdcReader2::run" << std::endl;
  }
...
//______________________________________________________________________________
void
Drs4QdcReader2::changeDaqMode(bool on)
{
  unsigned char buf1;
  int len = 1;
  if (on) {
...
//______________________________________________________________________________
void
Drs4QdcReader2::resetDrs4Address()
{
...
extern "C"
{
  ...
  {
    RTC::Properties profile(drs4qdc2reader_spec);
    manager->registerFactory(profile,
                             RTC::Create<Drs4QdcReader2>,
                             RTC::Delete<Drs4QdcReader2>);
  }
};
