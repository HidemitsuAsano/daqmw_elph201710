...
#ifndef NIMEASIROCREADER2_H
#define NIMEASIROCREADER2_H
...
class NIMEASIROCReader2
    : public DAQMW::DaqComponentBase
{
public:
    NIMEASIROCReader2(RTC::Manager* manager);
    ~NIMEASIROCReader2();
